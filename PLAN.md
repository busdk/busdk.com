...
- [ ] 27.4.2026: kirjoita artikkeli UpCloud-runnerin yleisistä lifecycle- ja verkon bootstrap -kontrolleista, joissa runnerin start/delete-politiikka, transientit tilat, storage-poisto ja netplan-pohjainen yksityisverkon alustus kuvataan Bus-integraation käyttäjälle näkyvinä käyttöehtoina.
- [ ] 27.4.2026: kirjoita ajankohtainen taustajuttu ViDA-, EN 16931- ja Peppol-kehityksestä: miksi BusDK:n lasku- ja ALV-data kannattaa pitää rivitasolla rakenteisena, validoitavana ja rajapintariippumattomana ennen EU:n cross-border B2B -e-laskutuksen ja digitaalisen raportoinnin kiristymistä.
- [ ] 27.4.2026: kirjoita ajankohtainen taustajuttu Suomen 2026 ALV-kannoista, jossa 25,5 %, 13,5 %, 10 % ja 0 % sidotaan BusDK:n eksplisiittisiin `vat_percent`- ja `vat_treatment`-kenttiin sekä toimitus-/suorituspäivän merkitykseen.
- [ ] 27.4.2026: kirjoita ajankohtainen taustajuttu EU AI Act -valmiudesta taloushallinnon automaatiossa: miksi AI-avusteinen kirjanpito tarvitsee jäljitettävät eventit, ihmisen hyväksyttävät muutokset, käyttöoikeusscopeihin sidotut palvelut ja erotetun usage-/audit-lokin.
