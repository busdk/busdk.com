...
- [ ] 28.4.2026: jatka auditointia provider-submoduulien nykyisistä tracked-diffeistä muuttamatta niitä. Päätä ovatko diffit toteutettuja ja paikallisesti testattavia Bus-pintoja, jotka vaativat blogipäivityksiä; jos kyllä, päivitä olemassa olevia artikkeleita ja aja vastaavat testit, jos ei, kirjaa löydökset katetuiksi ja sulje tämä kohta ilman avoimia PLAN-rivejä.
- [ ] Täydennä 26.4.2026 usage-provider-artikkelia `bus-api-provider-usage`-moduulin `/readyz`-storage-virheiden redaktoinnilla, jos diffin toteutus ja testit vahvistavat sen user-visible readiness-käyttäytymiseksi.
