...
var busDKTopHeaders = map[string]topHeaderConfig{
	...
	"engine": {
		...
		Links: []topHeaderLink{
			{ID: "overview", Href: "index.html", Label: "Overview"},
			{ID: "modules", Href: "modules/index.html", Label: "Capabilities"},
			{ID: "architecture", Href: "architecture/index.html", Label: "Architecture"},
			{ID: "runtime-images", Href: "runtime-images/index.html", Label: "Images"},
			{ID: "pricing", Href: "pricing/index.html", Label: "Pricing"},
			{ID: "faq", Href: "faq/index.html", Label: "FAQ"},
			{ID: "licensing", Href: "licensing/index.html", Label: "Licensing"},
			{ID: "contact", Href: "contact/index.html", Label: "Contact"},
		},
	},
	"books": {
